Public Class frmInputMoneyAmount
    ...
    Private Sub AddNumDigit(pbDigit As String)
        txtMoneyAmount.Text = txtMoneyAmount.Text.Replace(",", "")
        txtMoneyAmount.Text += pbDigit
        txtMoneyAmount.Text = Convert.ToDouble(txtMoneyAmount.Text).ToString("#,##0")
    End Sub
