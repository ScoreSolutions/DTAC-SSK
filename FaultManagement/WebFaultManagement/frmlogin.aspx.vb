...
Partial Class frmLogin
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        If txtUsername.Text.ToUpper <> "ADMIN" Then
            Try
                ...
                lPara = eng.WebFaultGetLDAP(txtUsername.Text.Trim, txtPassword.Text.Trim)
    ...
    Private Sub CreateUserProfile(ByVal UserName As String)
        ...
        Dim eng As New Engine.Common.LoginENG
        eng.SaveLoginHistory(UserName, Request, "QisWebFaultManagement")
