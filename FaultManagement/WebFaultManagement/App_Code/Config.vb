...
Public Class Config
    Public Shared Function GetLogOnUser() As UserProfilePara
        ...
        Try
            ...
            ret = Nothing 'Engine.Common.LoginENG.GetLogOnUser
    ...
    Public Shared Function GetWebFaultManagementVersion() As String
        Return ConfigurationManager.AppSettings("Version").ToString()
    End Function
    Public Shared Function GetFaultManagementServiceURL() As String
        Return ConfigurationManager.AppSettings("FaultManagementServiceURL").ToString()
    End Function
